...
public:
    ...
    static ClusterData gen_cluster_data( size_t features_num, size_t elements_num ,double* data);
    ...
    void reset();
    int save_labels(std::string name, std::vector <std::string> ndata, std::vector <std::string> uid,std::vector <int> *labs, double *data);
